...
##--your-code-starts-here--##
F_man = np.fft.fftshift(fft2(man))  # replace me
F_man_lowpass = np.fft.fftshift(fft2(man))  # replace me
F_wolft = np.fft.fftshift(fft2(wolf))  # replace me
F_wolft_highpass = np.fft.fftshift(fft2(wolf))  # replace me
##--your-code-ends-here--##
