...
our_filter=[[1,2,1],
            ...
            [1,2,1]]
# 
u, s, vh = np.linalg.svd(our_filter)
# 
VK= np.sqrt(s[0])*u[:,0]
HK= np.sqrt(s[0])*vh[0,:]
# 
gflt_imns = conv1(imns, VK)
gflt_imns = conv1(gflt_imns, HK)
# 
gflt_imng = conv1(imng, VK)
gflt_imng = conv1(gflt_imng, HK)
##--your-code-ends-here--##
...
def median_filter(img, wsize):
    ...
    for i in range(nrows):
        for j in range(ncols):
            ...
            ##--your-code-starts-here--##
            output[i,j]=np.median(img[iMin:iMax+1,jMin:jMax+1])
            ##--your-code-ends-here--##
...
##--your-code-starts-here--##
medflt_imns = median_filter(imns,3)  # do not replace me
medflt_imng = median_filter(imng,3)  # do not replace me
##--your-code-ends-here--##
